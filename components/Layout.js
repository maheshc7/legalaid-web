import { Box, Tooltip, IconButton, Avatar,Menu, MenuItem, Button, Stack, Typography } from '@mui/material';
        ...
        <header>
          <Stack direction={"row"} alignItems={"center"} justifyContent={"space-between"} marginX={2}>
            ...
            {isAuthenticated?(<>
              ...
              (<Button variant='contained' onClick={app.signIn} startIcon={ms_logo}>Sign In</Button>)
            }
          </Stack>
        </header>
        <main>{children}</main>
